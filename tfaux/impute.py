...
def impute(tensor_with_nan, similarities, ranks, alpha, regular, tol, n_iter_max, learning_rate):
    ...
    while True:
        ...
        core, factors = tucker(tensor, ranks, similarities, n_iter_max=n_iter_max, alpha=alpha, tol=tol, learning_rate=learning_rate, regular=regular, core=core, factors=factors, random_state=0)
